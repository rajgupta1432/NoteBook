...
/**
 * Create and manages a modal for adding or editing notes. The modal allows users to input a note's title and text.
...
const NoteModal = function (
  ...
  const onSubmit = function (callback) {
    $submitBtn.addEventListener("click", function () {
      const noteData = { title: $titleField.value, text: $textField.value };
...
/**
 * Creates and manage a modal for confirming the deletion of an item.
 *
...
const DeleteConfirmModal = function (title) {
  ...
  // Close the delete confirmation modal b y removing it from the document body
